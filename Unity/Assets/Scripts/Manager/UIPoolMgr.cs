...
*/
public sealed class UIPoolMgr : MonoBehaviour
{
    public static UIPoolMgr Instance { get; private set; }
...
#region public methods
    ...
    /// <returns></returns>
    public PanelBase LoadPanel(UIPanelType type)
    {
    ...
    public Transform LoadUIEffect(string effectName, Transform parent = null)
    {
